'''
setup.py — Install EVOLVE Observability on a new machine.
...
def run_install(args):
    print(_BOLD("\n=== EVOLVE Observability installer ===\n"))
    ...
    if wait_healthy(health_url):
        print(_GREEN("\nEVOLVE Observability is up and healthy."))
        print(f"\nNext steps:")
...
def run_check(args):
    print(_BOLD("\n=== EVOLVE Observability install check ===\n"))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="EVOLVE Observability installer")
